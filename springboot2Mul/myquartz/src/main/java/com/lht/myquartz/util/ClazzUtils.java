...
public class ClazzUtils {
    ...
    public static Map<String,Class>  getClazzNameAndObject(String packageName, boolean showChildPackageFlag){


        List<String> clazzNameList = null;
        Map<String,Class> classMap=new HashMap<>();
        try {
            clazzNameList = ClazzUtils.getClazzName(packageName, showChildPackageFlag);
            for (String clazzName : clazzNameList) {
                classMap.put(clazzName,Class.forName(clazzName));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
